...
class WorkerDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, training: { required: true, type: () => String }, user: { required: true, type: () => require("../../users/entities/user.entity").User } };
    }
}
__decorate([
...
], WorkerDto.prototype, "training", void 0);
__decorate([
    (0, class_transformer_1.Transform)(({ obj }) => obj.user),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", user_entity_1.User)
], WorkerDto.prototype, "user", void 0);
