...
class CreateReportDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { price: { required: true, type: () => Number }, make: { required: true, type: () => String }, model: { required: true, type: () => String }, approved: { required: true, type: () => Boolean }, year: { required: true, type: () => Number }, lng: { required: true, type: () => Number }, lat: { required: true, type: () => Number }, mileage: { required: true, type: () => Number, minimum: 0, maximum: 10000 } };
    }
}
__decorate([
...
], CreateReportDto.prototype, "approved", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
