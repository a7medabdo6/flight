...
const DDocs_controller_1 = require("./DDocs.controller");
...
DocsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([Docs_entity_1.Docs]), users_module_1.UsersModule],
        controllers: [DDocs_controller_1.DocsController],
