...
const {isLoading,mutate:SubmitEditeseat,isError,error,data:CreateSeatdata} =  EditeFlightApi()
...
const HandelSave=()=>{
  ...
  SubmitEditeseat(FormData)
    ...
    const items = {
        itemsAirLiens:( <>
          <input value={airlines} onChange={HandelAirlines} style={{borderRadius:"10px", backgroundColor:COLORS.blue,width:"100%"}} className="form-control" type="text" placeholder="130" aria-label="default input example"/>
  ...
  return (
    <div >
        ...
        <div>
           ...
           <EditSeatsCard title="Departure Date" Chosing={Inputs.InputDurationDate}/>
